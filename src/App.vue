...
const currentDoc = computed(() =>
  docs.value.find((d) => d.path === currentPath.value)
);
...
<template>
  <div class="bg-base-100 min-h-screen">
    ...
    >
      <div
        class="flex justify-between items-center p-4 border-base-300 border-b"
      >
    ...
    <aside
      class="hidden lg:block top-0 right-0 fixed p-6 w-56 h-screen overflow-y-auto"
    >
    ...
    <main class="lg:mr-56 lg:ml-64 min-h-screen">
      <div class="mx-auto px-4 lg:px-8 py-8 max-w-4xl">
        <article
          class="max-w-none prose prose-base"
          v-html="renderedHtml"
        ></article>
      </div>
    </main>
